...
public class CardViewPresidenAdapter extends RecyclerView.Adapter<CardViewPresidenAdapter.CardViewViewHolder>{
    private ArrayList<Presiden>listPresiden;
    private Context context;

    public CardViewPresidenAdapter(Context context) {
    ...
    public void onBindViewHolder(CardViewViewHolder holder, int position) {
        ...
        Presiden p = getListPresident().get(position);
